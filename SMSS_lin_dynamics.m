...
theta=eps;     % initial angular displacement
Rx=[1 0 0;
...
title('linearized dr')
subplot(2,2,2)
plot(t,dx_s,t,dy_s,t,dz_s)
xlabel('time [sec]')
ylabel('position displacement [m]')
title('simulation dr')
subplot(2,2,3)
plot(t,dx_s'-dx,t,dy_s'-dy,t,dz_s'-dz)
xlabel('time [sec]')
ylabel('error position displacement [m]')
title('error of dr')
subplot(2,2,4)
plot(t,err_x,t,err_y,t,err_z)
xlabel('time [sec]')
ylabel('error position displacement [m]')
...
title('linearized dv')
subplot(2,2,2)
plot(t,dvx_s,t,dvy_s,t,dvz_s)
xlabel('time [sec]')
ylabel('translational velocity [m/s]')
title('simulation dv')
subplot(2,2,3)
plot(t,dvx_s-dvx,t,dvy_s-dvy,t,dvz_s-dvz)
xlabel('time [sec]')
ylabel('error translational velocity [m/s]')
title('error dv')
subplot(2,2,4)
plot(t,err_vx,t,err_vy,t,err_vz)
xlabel('time [sec]')
...
figure
subplot(2,2,1)
plot(t,dmx,t,dmy,t,dmz)
xlabel('time [sec]')
ylabel('angular displacement [rad]')
title('linearized dm')
subplot(2,2,2)
plot(t,dmx_s,t,dmy_s,t,dmz_s)
xlabel('time [sec]')
ylabel('angular displacement [rad]')
title('simulation dm')
subplot(2,2,3)
plot(t,dmx_s-dmx',t,dmy_s-dmy',t,dmz_s-dmz')
xlabel('time [sec]')
ylabel('angular displacement [rad]')
title('error dm')
subplot(2,2,4)
plot(t,err_phix,t,err_phiy,t,err_phiz)
xlabel('time [sec]')
ylabel('angular displacement [rad]')
...
figure
subplot(2,2,1)
plot(t,dox,t,doy,t,doz)
xlabel('time [sec]')
ylabel('angular velocity [rad/s]')
title('linearized \omega')
subplot(2,2,2)
plot(t,dox_s,t,doy_s,t,doz_s)
xlabel('time [sec]')
ylabel('angular velocity [rad/s]')
title('simulation \omega')
subplot(2,2,3)
plot(t,dox_s-dox,t,doy_s-doy,t,doz_s-doz)
xlabel('time [sec]')
ylabel('angular velocity [rad/s]')
title('error\omega')
subplot(2,2,4)
plot(t,err_omegax,t,err_omegay,t,err_omegaz)
xlabel('time [sec]')
ylabel('angular velocity [rad/s]')
